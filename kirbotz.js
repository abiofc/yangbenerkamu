...
key: { 
        ...
        message: { 
"groupInviteMessage": {
"groupJid": "6288232154376-1616169743@g.us",
...
{"quickReplyButton": {"displayText": "Premium","id": 'sewabot'}},
...
const botzkir = "6288232154376@s.whatsapp.net"
...
Saya ⫹⫺ Ｒｙｕｕｋａ－ＭＤ 仫 , Bot Ini Menggunakan Sistem Multi Device WhatsApp.\n\nJadi Jika Kamu Menemukan Bug Atau Kesalahan Silahkan Laporkan Kepada Owner Agar Segera Di Perbaiki.\n\nTerima Kasih🙏.`
let buttons = [
{buttonId: `${prefix}creator👥`, buttonText: {displayText: 'Owner Nya Dek'}, type: 1},
...
➥ ${ya}Rank${ya} : ${role}
➥ ${ya}Status${ya} : ${elit}
➥ ${ya}Balance{ya} : $${(getBalance(sender, balance))}
➥ ${ya}Xp{ya} :  ${getLevelingXp(sender)}/${reqXp}
─〇
*Liat Menu Klik Baca Selengkapnya Yah Dek,Oh Ya Jangan Spam Yah Asu*
...
break
case 'Bot': case 'Woi Bot':{
replyNya(`Apasih Dek Minimal Sewa Lah Asw *${pushname}*`)
}
break
...
hydratedFooterText: 'Jika Kamu Menemukan Semacam Bug Atau Kesalahan Mohon Dimaklumi Dulu Yaa, Karena Owner Cuma Copas Paste🙏',
hydratedButtons: [{
urlButton: {
displayText: 'Owner Bot',
url: `${wame}`
...
╭━━━━「 * UP TO PREMIUM* 」
┊⫹⫺ *Hemat:* 10k (1 minggu)_
┊⫹⫺ *Normal:* 15k (2 minggu)_
┊⫹⫺ *Pro:* 20k (1 Bulan)_                                               
┊⫹⫺ *Permanent:* = Buat Bot Sendiri Aja Kontol_
╰═┅═━––––––๑
...
–––––– *🐾 Kebijakan* ––––––
🗣️: Kak, Kok harganya Murah Banget?
...
case 'welcome': {
if (!m.isGroup) return
await replyTemplate(`Welcome ${pushname}\nJangan Lupa Baca Deskripsi\nPatuhi Rules Bot!!!`)
}
break
case 'bye': {
if (!m.isGroup) return
...
query = args.join(" ")
naon = ['Iya','Tidak','Mungkin','Lah Nanya Bot']
...
thumbnail: ppnyauser,
mediaType:2,
mediaUrl: "https://youtu.be/MYgg5FMAYvU",
sourceUrl: "https://youtu.be/MYgg5FMAYvU"
}}}, { quoted: m })
}
break
